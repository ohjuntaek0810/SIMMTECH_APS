...
{
    public class TH_TAR_WRG_IO_PTN_DAILY_PROD_TARGET
    {
        /// <summary>
        /// 공통 저장프로시저
        /// </summary>
 ...
 //           @DIVISION_ID NVARCHAR(10)
	//,@APS_WIP_ROUTE_GRP_ID NVARCHAR(10)
	//,@LAYER_INOUT NVARCHAR(10)
	//,@PATTERN_TYPE_L1 NVARCHAR(10)
	//,@DAILY_PRODUCTION_TARGET_QTY FLOAT(8)
	//,@USE_YN NVARCHAR(10)
	//,@USER_ID NVARCHAR(10)

            sSQL.Append($@"

EXECUTE [dbo].[SP_SAVE_TH_TAR_WRG_IO_PTN_DAILY_PROD_TARGET]
    {Data["GROUP"].V}
    , {Data["APS_WIP_ROUTE_GRP_ID"].V}
    , {Data["LAYER_INOUT"].V}
    , {Data["PATTERN_TYPE_L1"].V}
    , {Data["DAILY_PRODUCTION_TARGET_QTY"].V}
    , {Data["USE_YN"].V}
    , {Data["USER_ID"].V}
");
