...
const list = document.querySelectorAll(".nav-tabs");
...
let widthOfList = function() {
    ...
    const listLinks = document.querySelectorAll(".nav-tabs .nav-item");
...
scrollerRight.addEventListener("click", function() {
    ...
    move(document.querySelectorAll(".nav-tabs")[0]).add("left", +widthOfHidden(wR), 200).end().then(x=> {
        reAdjust();
    });
});
...
scrollerLeft.addEventListener("click", function() {
    ...
    move(document.querySelectorAll(".nav-tabs")[0]).add("left", -getLeftPosi() + wL, 200).end().then(()=> {
        reAdjust();
    });
});
