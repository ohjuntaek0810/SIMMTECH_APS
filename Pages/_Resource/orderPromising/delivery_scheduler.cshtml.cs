...
{
    public class delivery_scheduler : BasePageModel
    {
        public delivery_scheduler()
        {
        ...
        private DataTable Search(Params terms)
        {
            ...
            result.Columns.Add("Inventory QTY", typeof(string));
            ...
            result.Columns.Add("지연 예상일수", typeof(string));
            result.Columns.Add("납기준수량", typeof(string));
            result.Columns.Add("지연수량", typeof(string));
            result.Columns.Add("test1", typeof(string));
            result.Columns.Add("test2", typeof(string));
            result.Columns.Add("test3", typeof(string));
            result.Columns.Add("test4", typeof(string));
            result.Columns.Add("test5", typeof(string));


            result.Rows.Add("2025-02-27", "D2", "SESS", "SESS", "TEST MODEL 99999", "2005156493", "MCP22377A00", "","566,040", "174.7", "", "", "", "", "", "", "");
